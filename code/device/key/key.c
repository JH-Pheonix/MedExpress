...
volatile vuint8 key_msg_front = 0, key_msg_rear = 0;
volatile vuint8 key_msg_flag = KEY_MSG_EMPTY;
...
{
    KEY_e keynum;
    static vuint8 keytime[KEY_NUM] = {0};
    KEY_MSG_t keymsg_local;
    vuint8 key_pressed = 0; // 标记是否有按键被按下
