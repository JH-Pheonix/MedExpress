...
#define IMU963RA_SPI (IMU_SPI_INDEX)          // 硬件 SPI 号
#define IMU963RA_SPC_PIN (IMU_SPC_PIN)        // 硬件 SPI SCK 引脚
#define IMU963RA_SDI_PIN (IMU_MOSI_PIN)       // 硬件 SPI MOSI 引脚
#define IMU963RA_SDO_PIN (IMU_MISO_PIN)       // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif

#define IMU963RA_CS_PIN (IMU_CS_PIN) // CS 片选引脚
